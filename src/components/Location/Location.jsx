...
import { 
  HStack, Button, Grid, GridItem, FormControl, 
  FormLabel, Input, Checkbox, CheckboxGroup, 
  Wrap, Textarea, Box, FormErrorMessage,
      ...
      <Modal closeOnOverlayClick={false} finalFocusRef={finalRef} isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          <ModalHeader color="green.500">
            <Text> <CheckIcon color={"green.500"} /> Lead Submission Success</Text>
          </ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            Lead submitted successfully! Click <b>Submit Another</b> to add a new lead or close this window.
          </ModalBody>

          <ModalFooter>
            <Button colorScheme='green' mr={3} onClick={() => window.location.reload()}>
              Submit Another
            </Button>
          </ModalFooter>
        </ModalContent>
